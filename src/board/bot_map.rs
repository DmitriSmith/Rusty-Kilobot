...
pub struct BotMap
{
    ...
    pub locations: Vec<Option<BotLocation>>,         //2D array packed into a Vector
}
...
impl BotMap
{
    ...
    pub fn new(width: u8, height: u8) -> BotMap
    {
        let mut new_map = BotMap{width, height, locations: Vec::with_capacity((width * height).into())};
